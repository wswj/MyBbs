                                ...
                                <div class="col-md-12 show_article_go">
                                    <div class="row">
                                        <div class="col-xs-7 col-md-9"
                                            ...
                                            <small>热门内容，来自：<a href="${APP_PATH }/common/getArticleBname.do?bname=${listArticle.bname }">${listArticle.bname }</a></small>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-2 col-md-1">
                                            <a href="${APP_PATH}/userController/getOthers.do?userid=${listArticle.userid }">
                                        ...
                                        <div class="col-xs-6 col-md-8">
                                            <a class="a_b" href="${APP_PATH}/userController/getOthers.do?userid=${listArticle.userid }">
                                            ...
                                            <c:if test="${!empty username && listArticle.username!=username}">
                                                ...
                                                <c:forEach var="attention" items="${attention }">
                                                    ...
                                                    <c:if test="${attention.userid==userid && attention.beuserid==listArticle.userid}">
                                                        <form action="${APP_PATH }/attentionController/deleteAttention.do" method="post">
                                                ...
                                                <c:if test="${attention_record==\"false\" }">
                                                    <form action="${APP_PATH }/attentionController/setAttention.do" method="post">
                                    ...
                                    <div class="row" style="position: relative;top: -10px;">
                                        <div class="col-xs-10 col-md-6">
                                            ...
                                            <div class="col-xs-7 col-md-6">
                                                ...
                                                <c:if test="${!empty username && listArticle.username!=username }">
                                                    <!-- 每一次遍历帖子时初始化collect_record为false” -->
                                                    ...
                                                    <c:forEach var="collect" items="${collect }">
                                                        ...
                                                        <c:if test="${collect.userid==userid && collect.fid==listArticle.fid}">
                                                            <form action="${APP_PATH }/collectController/deleteCollect.do" method="post">
                                                    ...
                                                    <c:if test="${collect_record==\"false\" }">
                                                        <form action="${APP_PATH }/collectController/setCollect.do" method="post">
                                                            <input type="hidden" name="userid" value="${userid }">
                                    ...
                                    <c:if test="${!empty username}">
                                        ...
                                        <div class="row" style="position: relative; margin-top: 10px;">
                                            <div class="col-xs-12 col-md-12">
                                                <form action="${APP_PATH }/commentController/setComment.do">
            ...
            <div class="row">
                <c:forEach var="plate" items="${plate }" varStatus="status" >
                    <div class="col-xs-4 col-md-4">
                        <a href="${APP_PATH }/common/getArticleBname.do?bname=${plate.bname }">
